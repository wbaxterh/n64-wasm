...
class N64GameDB {
  ...
  init() {
    ...
    const games = [
      { crc: 'D6FBA4A8-6D0D3837', name: "Tony Hawk's Pro Skater", year: 2000, genre: 'Sports' },
      { crc: 'C20A4F28-93E2DA86', name: "Tony Hawk's Pro Skater 2", year: 2001, genre: 'Sports' },
      { crc: '4EAA3D0E-74757C24', name: 'Super Mario 64', year: 1996, genre: 'Platformer' },
      { crc: 'EC7011B7-7616D72B', name: 'The Legend of Zelda: Ocarina of Time', year: 1998, genre: 'Action-Adventure' },
      { crc: 'D6133266-00000000', name: "The Legend of Zelda: Majora's Mask", year: 2000, genre: 'Action-Adventure' },
      { crc: 'B7F14D68-4B4B7682', name: 'Mario Kart 64', year: 1996, genre: 'Racing' },
      { crc: 'D62D54B7-EA2E3EEA', name: 'GoldenEye 007', year: 1997, genre: 'FPS' },
      { crc: 'B58B8CD0-FCEA3B04', name: 'Super Smash Bros.', year: 1999, genre: 'Fighting' },
      { crc: 'A722F8A0-C9B35C7A', name: 'Star Fox 64', year: 1997, genre: 'Shooter' },
      { crc: 'B4B46CA6-C3B325F1', name: 'Banjo-Kazooie', year: 1998, genre: 'Platformer' },
      { crc: 'CD1A2447-81ECCEC5', name: 'Banjo-Tooie', year: 2000, genre: 'Platformer' },
      { crc: '3A0DE1B3-7AB82889', name: 'Donkey Kong 64', year: 1999, genre: 'Platformer' },
      { crc: '0DD4ABAB-B5A2A91E', name: 'Paper Mario', year: 2000, genre: 'RPG' },
      { crc: '2B455501-9C0D5252', name: 'Diddy Kong Racing', year: 1997, genre: 'Racing' },
      { crc: '305E199D-3FF97B6D', name: 'Perfect Dark', year: 2000, genre: 'FPS' },
      { crc: 'FF2B5A63-0C3C88A4', name: 'F-Zero X', year: 1998, genre: 'Racing' },
      { crc: 'D82BAD64-36D4A3DE', name: '1080 Snowboarding', year: 1998, genre: 'Sports' },
      { crc: '9EA95858-AF72B618', name: 'Wave Race 64', year: 1996, genre: 'Racing' },
      { crc: 'E4558F66-A3E7C1B7', name: 'Kirby 64: The Crystal Shards', year: 2000, genre: 'Platformer' },
      { crc: '0A12A79F-000000FF', name: 'Conker\'s Bad Fur Day', year: 2001, genre: 'Platformer' },
      { crc: '492F4A6B-57B3FE29', name: 'Yoshi\'s Story', year: 1997, genre: 'Platformer' },
      { crc: 'CFBB4E6A-7FBACA63', name: 'Excitebike 64', year: 2000, genre: 'Racing' },
      { crc: 'CCC7FBAF-B12A6A64', name: 'Pokémon Snap', year: 1999, genre: 'Photography' },
      { crc: 'CF132959-E25D2418', name: 'Pokémon Stadium', year: 1999, genre: 'Strategy' },
      { crc: '66881024-FCB06E53', name: 'Pokémon Stadium 2', year: 2000, genre: 'Strategy' },
      { crc: 'B6BC0D26-1F073C39', name: 'Turok: Dinosaur Hunter', year: 1997, genre: 'FPS' },
      { crc: 'B6D5B3A2-AEA15CF9', name: 'Turok 2: Seeds of Evil', year: 1998, genre: 'FPS' },
      { crc: '2337D219-6F8F69C6', name: 'Jet Force Gemini', year: 1999, genre: 'Shooter' },
      { crc: 'F568D51E-C05E0660', name: 'Blast Corps', year: 1997, genre: 'Action' },
      { crc: 'C2E9AA9A-3CE7D308', name: 'Pilotwings 64', year: 1996, genre: 'Flight Sim' },
      { crc: '6A471710-06F49BB9', name: 'Doom 64', year: 1997, genre: 'FPS' },
      { crc: '78A20148-F6E9F715', name: 'Quake 64', year: 1998, genre: 'FPS' },
      { crc: '9C2B0D31-0CE77AA5', name: 'Bomberman 64', year: 1997, genre: 'Action' },
    ];
